...
export const lang_en: LangObj = {
  ...
  "Print and export scale": "Print and export scale",
  "The created tile images will be scaled by this factor. If it is more than 1 then the images will be larger, if is less than 1 the images will be smaller. Scaling is not applied to svg export": "The created tile images will be scaled by this factor. If it is more than 1 then the images will be larger, if is less than 1 the images will be smaller. Scaling is not applied to svg export",
