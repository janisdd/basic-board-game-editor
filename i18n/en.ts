...
export const lang_en: LangObj = {
  ...
  "Enables the next field mode. When you then click on a field (the next field) then a control goto statement is added to the command text and the next field is selected. To quit the mode click elsewhere on the canvas. Press the shortcut again to disable the mode or <div class='keys'>esc</div>.": "Enables the next field mode. When you then click on a field (the next field) then a control goto statement is added to the command text and the next field is selected. To quit the mode click elsewhere on the canvas. Press the shortcut again to disable the mode or <div class='keys'>esc</div>.",
  ...
  "The next field id is used for simulation to know where we need to go next if we step on this border point": "The next field id is used for simulation to know where we need to go next if we step on this border point",
  //--- //--,
  ...
  "Enables the next field mode. When you then click on a field (the next field) then a control goto statement is added to the command text and the next field is selected. To quit the mode click elsewhere on the canvas. Shortcut: <div class='keys'>ctrl+n</div>, <div class='keys'>cmd+n</div>. Press the shortcut again to disable the mode or <div class='keys'>esc</div>.": "Enables the next field mode. When you then click on a field (the next field) then a control goto statement is added to the command text and the next field is selected. To quit the mode click elsewhere on the canvas. Shortcut: <div class='keys'>ctrl+n</div>, <div class='keys'>cmd+n</div>. Press the shortcut again to disable the mode or <div class='keys'>esc</div>.",
  "Height": "Height",
  "Width": "Width",
  "Color": "Color",
