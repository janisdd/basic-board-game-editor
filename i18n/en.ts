...
export const lang_en: LangObj = {
  ...
  "Forced field auto prepend text": "Forced field auto prepend text",
  "The text to prepend to the field text when the field is a (implicitly) forced field (command text is forced)": "The text to prepend to the field text when the field is a (implicitly) forced field (command text is forced)",
  "Forced field auto border size in px": "Forced field auto border size in px",
  "The border size to set when the field is a (implicitly) forced field (command text is forced)": "The border size to set when the field is a (implicitly) forced field (command text is forced)",
  "Forced field border color": "Forced field border color",
  "The border color to set when the field is a (implicitly) forced field (command text is forced)": "The border color to set when the field is a (implicitly) forced field (command text is forced)",
  "Forced field is font bold": "Forced field is font bold",
  "Forced field is font italic": "Forced field is font italic",
  "Branch if prepend text": "Branch if prepend text",
  "The text to prepend to the field text when the field command is a branching if (control if)": "The text to prepend to the field text when the field command is a branching if (control if)",
  "Branch if auto border size in px": "Branch if auto border size in px",
  "The border size to set for the field text when the field command is a branching if (control if)": "The border size to set for the field text when the field command is a branching if (control if)",
  "Branch if border color": "Branch if border color",
  "The border color to set for the field text when the field command is a branching if (control if)": "The border color to set for the field text when the field command is a branching if (control if)",
  "Branch if is font bold": "Branch if is font bold",
  "Branch if is font italic": "Branch if is font italic",
