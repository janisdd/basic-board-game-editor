...
export interface LangObj {
  ...
  "Is ar.js enabled": string
  "For Ar.js you will need a camera and a (printed) marker. When you point the camera onto the marker the ar scene will be rendered over the marker": string
  "Tile size in meters": string
